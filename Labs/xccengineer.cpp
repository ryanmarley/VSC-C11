/**
    CS-11 Lab 10a EC, xccengineer.cpp
    Purpose: Add toString() to original 
    Attribution: https://www.youtube.com/watch?v=LM6EDIKS5Pk
...
class CEngineer {
    public:
        ...
        */
        ...
        /**
            Method toString - creates a string for all data about engineer
            @param no parameters
            @return string with all data about the engineer
        */ 
        string toString();
...
string CEngineer::toString() {
    stringstream sso;
    sso << setprecision(2) << fixed << _income;
    string strIncome;
    sso >> strIncome;
    return _name + "\t  " + _occupation + "\t" + strIncome;
}
